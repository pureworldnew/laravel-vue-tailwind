<nav class="bg-white py-2 md:py-4">
    <div class="container px-64 mx-auto md:flex md:items-center">

        <div class="flex justify-between items-center">
            <a href="#" class="font-bold text-xl text-indigo-600"><img src="{{ asset('img/logo.svg') }}" alt="tag" width="100%", height="100%"></a>
