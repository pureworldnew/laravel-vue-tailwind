    ...
    <div class="header_area">
        <div class="max-w-full">
            <div class="flex md:justify-between py-2.5 2xl:px-64 xl:px-44 mx-auto sm:px-6 lg:px-8 shadow-md">
                <img :src="'/img/logo.png'" alt="profile Pic" height="200" width="200">
                ...
                <ul class="hidden md:flex md:flex-row self-center" id="mobileMenu">
                    ...
                    <li class="pr-9">
                        <a class="hover:text-product-red-600 uppercase font-semibold text-base" href="#">About us</a>
                    </li>
                    <li class="">
                        <a class="hover:text-product-red-600 uppercase font-semibold text-base" href="#">contact us</a>
                    </li>
                </ul>
            </div>
            <div class="bg-category-back-500 md:justify-between 2xl:px-64 xl:px-44 sm:px-6 lg:px-8">
                <div class="flex justify-between py-9">
                    ...
                    <div class="flex flex-row justify-center items-center">
                        ...
                        <div class="pl-3 text-custom-red-400 tracking-normal text-sm"><a href="">See More</a></div><i
                            class="fas fa-angle-right pl-3 text-custom-red-400"></i>
                    </div>
                </div>

                <div class="grid gap-10 grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 pb-10" >
                    <div class="flex flex-col" v-for="n in 8" v-bind:key="n">
                        <img :src="'/img/' + n + '.png'" class="w-full mb-4" />
                        <div class="flex flex-row justify-start items-center mb-3.5">
                            <img :src="'/img/disc.png'" class="w-4 h-4 mr-4" />
                        ...
                        <div class="flex flex-row justify-between">
                            ...
                            <input class="bg-custombtn-red-400 text-sm text-white rounded-full w-20" type="button"
                                value="View all" />
                        </div>
                    </div>
                </div>
            ...
            <div class="md:justify-between 2xl:px-64 xl:px-44 sm:px-6 lg:px-8">
                <div class="flex justify-between py-9">
                    ...
                    <div class="flex flex-row justify-center items-center">
                        <hr class="pl-3 border-t border-solid w-8 border-red-400" />
                        <div class="pl-3 text-custom-red-400 tracking-normal text-sm h-7"><a href="">View all</a></div>
                ...
                <div class="grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 pb-10" >
                    <div class="flex flex-col" v-for="n in 12" v-bind:key="n">
                        <img :src="'/img/product.png'" class="w-full mb-4" />
                        <div
            ...
            <div class="flex md:justify-between 2xl:px-64 xl:px-44 sm:px-6 lg:px-8 bg-apply-part py-16">
                <div class="flex flex-col justify-start w-full">
                    ...
                    <div class="text-2xl font-semibold text-white pb-4">Top quality service, guaranteed satisfaction,
            ...
            <div
                ...
                <div class="flex flex-row flex-nowrap">
                    <img :src="'/img/news.png'" alt="Newsletter pic" class="pr-6" />
                    <div class="text-sm	text-category-subtitle-600 self-center">
                        ...
                        <div class="text-sm	text-category-subtitle-600 font-semibold">New releases, special offers, and
                            more.</div>
                    </div>
                </div>
            ...
            <div class="flex flex-col 2xl:px-64 xl:px-44 sm:px-6 lg:px-8">
                <div class="py-8 grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                    ...
                    <div class="flex flex-col py-9 2xl:pl-24">
                        ...
                        <div class="uppercase text-sm leading-7 text-footer-color-400 mb-3">trailer dealer website by
                        </div>
                        <img :src="'/img/connect.png'" alt="connect image" class="mb-2 w-3/4" />
